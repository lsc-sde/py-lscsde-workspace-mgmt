...
from ..models import AnalyticsDataSource
...
class TestDataSource:
    def test_datasource_conversion(self):
        ...
        assert (
            "test-secret"
            == datasource.spec.connections[
                0
            ].databricks_connection.personal_access_token.secret_name
        )
        assert (
            "TOKEN"
            == datasource.spec.connections[
                0
            ].databricks_connection.personal_access_token.secret_key
        )
    ...
    def mock_datasource(self):
        return {
            ...
            "metadata": {
                ...
                "generation": 1,
                "labels": {"xlscsde.nhs.uk/type": "uploaded"},
            ...
            "spec": {
                ...
                "project": {"id": "d4e6"},
                "publisher": {
                    "contact": {"name": "Joe Bloggs", "role": "Research Engineer"},
